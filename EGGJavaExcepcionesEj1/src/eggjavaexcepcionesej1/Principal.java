   ...
   static double may=0 , me=0 ;
    ...
    public static void main(String[] args) throws AWTException {
        ...
        //  Persona p[] = new Persona[4];           
         ...
         //System.out.println("ingreso de dato "+(i+1)+" de 4 personas ");
         //   p[i]= per.crearPersona();
         //   dato1=per.esMayorDeEdad( p[i]); MensajeMEdad(dato1); dato= per.calcularIMC(p[i]); MensajePeso(dato); 
       // }
