...
public class Persona {
    ...
    private void comprobarSexo() {  //Si el sexo no es una M o una F  u O otro, se muestra por consola mensaje de error ..        
        if (this.sexo != "M" && this.sexo != "F" && this.sexo != "O"  ) {
            System.out.println("sexo ingresado es incorrecto ......");
        }
    }
   @Override
