...
public class Principal {
    ...
    public static void main(String[] args) {         
      ...
      Alquiler dato=new Alquiler("gerald",44314246,7);
      Barco  dato1=new Barco(334722,100,2015,"deportivo");
    
      System.out.println("nombre: "+dato.nombre );
      System.out.println(" con dni nª: "+dato.dni);
      System.out.println("numero de dias de alquiler "+dato.numdias);
      System.out.println("total alquiler es:  "+((dato.numdias*(dato1.eslora*10))*2));
    }
