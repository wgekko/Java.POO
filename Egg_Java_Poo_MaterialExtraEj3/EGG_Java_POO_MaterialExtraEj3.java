 ...
 * @author WALTER GOMEZ
 */
public class EGG_Java_POO_MaterialExtraEj3 {
    ...
    public static void main(String[] args) {
        ...
        a = leer.nextDouble();
        System.out.println("Digite el dato b : ");
        b = leer.nextDouble();
        System.out.println("Digite el dato c : ");
        c = leer.nextDouble();

        RaicesControl raiz = new RaicesControl(a,b,c);
        raiz.calcular();
