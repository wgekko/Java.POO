...
public abstract class ExtraHotel extends Alojamiento {
    ...
    public ExtraHotel(boolean privado, Integer mts2, String nombre, String direccion, String localidad, String gerente) {
    ...
    public void creaExtraHotel() {
        ...
        if (op.equalsIgnoreCase("S") ) {
            ...
            System.out.println("Se ha Ingresado una opcion no validad se considera que es privado ...");
            this.privado = true;
        }

        System.out.println("Ingrese la cantidad de metros cuadrados tiene ...");
