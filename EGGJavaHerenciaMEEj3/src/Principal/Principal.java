...
import Entidad.Hotel4.Gimnasio;
...
public class Principal {
    ...
    public static void main(String[] args) {
      ArrayList<Alojamiento> lista = new ArrayList();
        Hotel4 h1 = new Hotel4("El Chori Loco", 40, Gimnasio.A, 50, 70, 3, "Hotelo", "Oscuridad 69", "Tangamandapio", "Sevelinda Parada");
        h1.precioHabitacion();
        lista.add(h1);
        Hotel4 h2 = new Hotel4("Que se Come", 80, Gimnasio.A, 40, 45, 2, "El Sinestrellas", "Juan V. Poco 111", "Chapanay", "Micho Tito");
        h2.precioHabitacion();
        lista.add(h2);
        Hotel5 h3 = new Hotel5(1, 5, 2, "El Salpicon", 80, Gimnasio.A, 100, 150, 6, "MejorSolo", "Juan D. Perron 450", "Ugarteche", "Elber Galarga");
        h3.precioHabitacion();
        lista.add(h3);
        Hotel5 h4 = new Hotel5(2, 15, 5, "Puchero's", 50, Gimnasio.A, 80, 90, 20, "El Descanso", "Parque Chachingo", "Maipu", "Dolores D'Lano");
        h4.precioHabitacion();
        lista.add(h4);
