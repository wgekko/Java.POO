    ...
    public static void main(String[] args) {
        ...
        for (Edificio e : ed) {
            ...
            if (e instanceof EdificioOficina) {
                ...
                System.out.println(" Edificio de Oficina con  : " + ((EdificioOficina) e).getNroOfic()
                        + " oficinas  \n tiene una superficie en m2 de : " + df.format(e.calcularSup())
                        + "\n y un volumen de : " + df.format(e.calcularVol()));
                //continue;
            }
        ...
        for (Edificio e : ed) {
            if (e instanceof Polideportivo) {
                int datoa = 0, datoc = 0;
                Polideportivo obj = (Polideportivo) e;
                if (((Polideportivo) e).getTipoInstalacion().equalsIgnoreCase("abierto")) {
                    datoa++;
                    System.out.println("\033[35m nombre " + ((Polideportivo) e).getNombre()
                            + "\n tiene un tipo de instalación  : " + ((Polideportivo) e).getTipoInstalacion()
                            + "\n total de instalacion/es abierta/a : " + datoa);
                    //continue;
                }
                if (((Polideportivo) e).getTipoInstalacion().equalsIgnoreCase("cerrado")) {
                    datoc++;
                    System.out.println("\033[35m nombre " + ((Polideportivo) e).getNombre()
                            + "\n tiene un tipo de instalación  : " + ((Polideportivo) e).getTipoInstalacion()
                            + "\n total de instalacion/es abierta/a : " + datoc);
                    //continue;
                }
            }
        }
           for (Edificio e : ed) {          
            if (e instanceof EdificioOficina) {
                int c=0;
                EdificioOficina obj = (EdificioOficina) e;
                System.out.println("\033[33mEdificio de Oficina #"+c+" tiene una capacidad de : " + ((EdificioOficina) e).getCantPersOfic()+ " personas" );
                //continue;
            }
